...
# TOD0: use a list comprehension to create a list of integers from this list of strings
numbers = [int(i) for i in almost_numbers]
print(numbers)


# TOD0: use a list comprehension to create a list of all of the full_names in lowercase
lowercase_full_names = [char.lower() for char in full_names]
